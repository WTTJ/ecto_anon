defmodule EctoAnon.Functions.Default do
  ...
  defp do_run(:utc_datetime_usec, _value), do: @default_datetime
  defp do_run(:naive_datetime, _value), do: @default_naive_datetime
  defp do_run(:naive_datetime_usec, _value), do: @default_naive_datetime
  defp do_run(:time, _value), do: @default_time
  defp do_run(:time_usec, _value), do: @default_time
